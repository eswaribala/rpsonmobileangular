...
import { ViewVehicleComponent } from './vehicle/viewvehicle/view-vehicle.component';
...
import { EngineComponent } from './vehicle/engine/engine.component';
import { HighlightComponent } from './vehicle/highlight/highlight.component';
import { ColorDirective } from './vehicle/viewvehicle/color.directive';
@NgModule({
  declarations: [
    AppComponent,
    MenuComponent,
